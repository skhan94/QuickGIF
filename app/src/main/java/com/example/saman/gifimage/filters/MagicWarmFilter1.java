...
public class MagicWarmFilter1 extends GPUImageFilter {
...
/*  public static int green_state=0;
    ...
    public MagicWarmFilter1(int green){

        super(NO_FILTER_VERTEX_SHADER, OpenGLUtils1.readShaderFromRawResource(R.raw.warm));
        //  this.c=c;
...
/* Log.e("Activity","Green StateID1 " + green_state);
    ...
    public void onInit(){
      ...
      //  mToneCurveTextureUniformLocation = GLES20.glGetUniformLocation(mGLProgId, "curve");
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(getProgram(), "v_color");
            ...
            public void run(){
                ...
                switch(filter_number)
                {
                    ...
                    case 2:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/india1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/india1a.png");
                    ...
                    case 3:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/afghanistan1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/afghanistan1a.png");
                    ...
                    case 4:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/car1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/car1a.png");
                    ...
                    case 5:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/hungary1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/hungary1a.png");
                    ...
                    case 6:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/indonesia1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/indonesia1a.png");
                    ...
                    case 7:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/malaysia1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/malaysia1a.png");
                    ...
                    case 8:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/northkorea1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/northkorea1a.png");
                    ...
                    case 9:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/southkorea1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/southkorea1a.png");
                    ...
                    case 10:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/ukraine1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/ukraine1a.png");
                    ...
                    case 11:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/uruguay1.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/uruguay1a.png");
