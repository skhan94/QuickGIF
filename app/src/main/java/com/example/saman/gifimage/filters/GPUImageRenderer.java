...
public class GPUImageRenderer implements Renderer, PreviewCallback {
    ...
    private GPUImage1.ScaleType mScaleType = GPUImage1.ScaleType.CENTER_INSIDE;
    ...
    public void setScaleType(GPUImage1.ScaleType scaleType) {
    ...
    private void adjustImageScaling() {
        ...
        if (mScaleType == GPUImage1.ScaleType.CENTER_CROP) {
