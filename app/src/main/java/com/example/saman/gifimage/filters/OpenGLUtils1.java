...
/**
 * Created by saman on 8/10/2016.
 */
public class OpenGLUtils1 {
    ...
    public static int loadTexture(final Context context, final String name){
        ...
        if (textureHandle[0] != 0){
            Log.e("Activity", "FRONT ID " + MagicParams.front);
            ...
            {
                //for front camera
                Bitmap loadedbitmap = getImageFromAssetsFile(context, name);
               /* Matrix rotateMatrix = new Matrix();
                ...
                bitmap = Bitmap.createBitmap(loadedbitmap, 0, 0,
