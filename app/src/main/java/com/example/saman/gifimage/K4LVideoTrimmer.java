...
public class K4LVideoTrimmer extends FrameLayout implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
    ...
    private void init(Context context) {
        ...
        mRangeSeekBarView.addOnRangeSeekBarListener((OnRangeSeekBarListener) progressVideoView);
    ...
    private void setTimeFrames() {
        String seconds = getContext().getString(life.knowledge4.videotrimmer.R.string.short_seconds);
    ...
    private void getSizeFile() {
        ...
        if (mOriginSizeFile == 0) {
            ...
            if (fileSizeInKB > 1000) {
                ...
                mTextSize.setText(String.format("%s %s", fileSizeInMB, getContext().getString(life.knowledge4.videotrimmer.R.string.megabyte)));
            } else {
                mTextSize.setText(String.format("%s %s", fileSizeInKB, getContext().getString(life.knowledge4.videotrimmer.R.string.kilobyte)));
            }
        }
    }
