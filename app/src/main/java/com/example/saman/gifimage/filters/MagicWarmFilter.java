...
/*  public static int green_state=0;
    public static int filter_number=0;
  ...
  //  public static Context c;
    ...
    public MagicWarmFilter(int green){

        super(NO_FILTER_VERTEX_SHADER, OpenGLUtils.readShaderFromRawResource(R.raw.warm));
      //  this.c=c;

        Log.e("Activity","Green StateID1 " + green_state);
         Log.e("Activity","Green ID1 " + green);
    }
    ...
    public void onInit(){
        ...
        mMaskGrey2UniformLocation = GLES20.glGetUniformLocation(getProgram(), "layerImage");
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(getProgram(), "greyFrame");
    }
    ...
    public void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                ...
                Log.e("Activity","Filter Number " + filter_number );
                Log.e("Activity", "Filter green_state " + green_state);
          switch(filter_number)
                {
                    ...
                    case 1:
                        Log.e("Activity","Filter Number " + filter_number );
              if (green_state == 0) {
                  mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/pak.png");
              } else {
                  mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/pakb.png");

              }

                 */
/*       if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/green.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/green.png");
                    ...
                    case 2:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/india.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/indiab.png");
                    ...
                    case 3:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/afghanistan.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/afghanistanb.png");
                    ...
                    case 4:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/car.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/carb.png");
                    ...
                    case 5:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/hungary.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/hungaryb.png");
                    ...
                    case 6:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/indonesia.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/indonesiab.png");
                    ...
                    case 7:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/malaysia.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/malaysiab.png");
                    ...
                    case 8:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/northkorea.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/northkoreab.png");
                    ...
                    case 9:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/southkorea.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/southkoreab.png");
                    ...
                    case 10:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/ukraine.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/ukraineb.png");
                    ...
                    case 11:
                        ...
                        if (green_state == 0) {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/uruguay.png");
                        } else {
                            mMaskGrey1TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/uruguayb.png");

                        }

                        break;
                }
                mMaskGrey2TextureId = OpenGLUtils.loadTexture(MagicParams.context, "filter/green.png");
