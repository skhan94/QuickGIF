...
public class MagicLomoFilter extends GPUImageFilter{
    ...
    public void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
          //      inputTextureHandles[0] = OpenGLUtils.loadTexture(c, "filter/pak1.png");
                inputTextureHandles[0] = OpenGLUtils.loadTexture(c, "filter/lomomap_new.png");
              //  inputTextureHandles[1] = OpenGLUtils.loadTexture(c, "filter/pakistan.jpg");
              inputTextureHandles[1] = OpenGLUtils.loadTexture(c, "filter/vignette_map.png");
            }
        });
    }
}